...
namespace StudentTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Бодриков Владимир Константинович", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
                new Student{Name="Яковлев Евгений Павлович", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
                new Student{Name="Шириков Арсений Сергеевич", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
